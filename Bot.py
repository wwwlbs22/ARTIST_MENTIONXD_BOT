...
async def start(event):
    ...
    await event.client.send_file(
        ...
        buttons=[
            ...
            [Button.url("❤️‍🔥 ɢʀᴏᴜᴘ 💫", "https://t.me/the_ind_coders"), Button.url("❤️‍🔥 ᴄʜᴀɴɴᴇʟ 💫", "https://t.me/the_ind_coder")],
            [Button.url("❤️‍🔥 ʜᴇʀᴜᴋᴏ ᴄᴄ 💫", "https://t.me/h_cc_club"), Button.url("❤️‍🔥 INDIAN ❤️‍🔥", "https://t.me/ITZ_ADITYA_THE_KING")]
        ]
    )
...
async def help(event):
    ...
    await event.reply(
        ...
        buttons=(
            [
                Button.url("❤️‍🔥 ꜱᴜᴘᴘᴏʀᴛ 💫", "https://t.me/THE_IND_CODERS"),
                Button.url("❤️‍🔥 CHANNEL 💫", "https://t.me/the_ind_coder"),
            ]
        ),
    )
